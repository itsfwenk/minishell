...
/*   Updated: 2024/10/04 23:12:20 by mel-habi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (err)
		return (ERROR_EMOJI ESC_F BOLD RED PROMPT END_COLOR ESC_S);
	return (SUCCESS_EMOJI ESC_F BOLD GREEN PROMPT END_COLOR ESC_S);
}
