...
// /*                                                +#+#+#+#+#+   +#+           */
// /*   Created: 2024/09/05 16:47:55 by fli               #+#    #+#             */
// /*   Updated: 2024/09/05 16:47:55 by fli              ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */

// #include "../minishell.h"

// static void	exp_dup_special_char(t_string *current, char *expanded_str)
// {
// 	int	i;
// 	int	j;
...
// void	exp_special_char(t_string *current)
// {
// 	int		i;
// 	int		nb_pos_param;
// 	char	*expanded_str;
