...
#    Updated: 2024/10/01 18:18:11 by mel-habi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXEC_SRCS		= check_exit.c exec_subshell.c exec_utils.c execution.c fd_manager.c ft_exec.c get_fd.c get_path.c here_doc.c pid_list_manip.c
